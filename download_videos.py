...
def process_csv_file(file_path):
    ...
    os.makedirs(f"/Users{date_part}", exist_ok=True)
    ...
    fullDirPath = f"/Users/{date_part}/"+directory_name
    ...
    df.to_csv(f"/Users/{date_part}/"+file_path.stem+".csv", index=False)
...
if __name__ == "__main__":
    ...
    csvDir = "/Users/SampleElection/metadata_csv_day_chunks/"
